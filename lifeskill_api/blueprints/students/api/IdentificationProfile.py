class IdentificationProfile:
    ...
    def __init__(self, response):
        ...
        self._enrollment_speech_time = response.get(
            self._ENROLLMENT_SPEECH_TIME, None)
        self._remaining_enrollment_time = response.get(
            self._REMAINING_ENROLLMENT_TIME, None)
        self._created_date_time = response.get(self._CREATED_DATE_TIME, None)
        self._last_action_date_time = response.get(
